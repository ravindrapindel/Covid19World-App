...
function Mapes(props){
  ...
  // data is paased to mark on the map
    ...
    return( <>
      ...
      <div className={classes.unit1}> Radius of Circle: 1cm = 1000 Total Covid Cases Per 1M Population  </div>
      <div className={classes.unit2}> Intensity of Circle : Active Cases </div>
